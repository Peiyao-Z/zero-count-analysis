...
saveRDS(cellType_sum,"celltype/ST_HBC_celltype.rds")
rm(data,dat,tmp,cellType_sum)
...
saveRDS(cellType_sum,"celltype/NICHE-seq_celltype.rds")
rm(data,dat,tmp,cellType_sum)
## 10x-----------
#AdultMouseBrain10x
data<-Read10X_h5(paste0(datapath,"MouseBrain10x_count.h5"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
saveRDS(cellType_sum,"celltype/10x_MB(C)_celltype.rds")
rm(data,dat,tmp,cellType_sum)

#BC
data<-Read10X_h5(paste0(datapath,"BC10x_count.h5"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-Read10X_h5(paste0(datapath,"HumanHeart10x_count.h5"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-Read10X_h5(paste0(datapath,"HumanLymph10x_count.h5"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-Read10X_h5(paste0(datapath,"MouseKidney10x_count.h5"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-Read10X_h5(paste0(datapath,"MouseBrainAnterior10x_count.h5"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-Read10X_h5(paste0(datapath,"MouseBrainPosterior10x_count.h5"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
