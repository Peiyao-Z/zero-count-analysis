...
# 10x-----------
#AdultMouseBrain10x
data<-readRDS(paste0(datapath,'10x/',"MouseBrain10x_count.rds"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
#BC
data<-readRDS(paste0(datapath,'10x/',"BC10x_count.rds"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-readRDS(paste0(datapath,'10x/',"HumanHeart10x_count.rds"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-readRDS(paste0(datapath,'10x/',"HumanLymph10x_count.rds"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-readRDS(paste0(datapath,'10x/',"MouseKidney10x_count.rds"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-readRDS(paste0(datapath,'10x/',"MouseBrainAnterior10x_count.rds"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
data<-readRDS(paste0(datapath,'10x/',"MouseBrainPosterior10x_count.rds"))
tmp<-clusterPC(tmp = data,npcs = 15,resolution = 0.5)
colnames(data)<-Idents(tmp)
group<-levels(Idents(tmp))
cellType_sum <- list()
...
saveRDS(cellType_sum,"celltype_mom/ST_BC_celltype.rds")
rm(data,dat,tmp,cellType_sum)
...
cellType_sum <- list()
for (cellType in group[c(1:2,4:9)]) {
